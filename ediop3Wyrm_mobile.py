...
def usage():
	print 'ediop3 wyrm DDoS Tool ( lol )'
	print 'New loaded Botnets: 1,798,445,657'
	print 'Usage: ediop3Wyrm (url)'
	print 'Example: ediop3Wyrm.py http://luthi.co.il/'
	print "\a"
print \
"""
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				previous=request_counter
		if flag==2:
			print "\n-- Sending mass amount of packets hehe --"
